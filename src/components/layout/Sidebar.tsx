...
import { Home, Search, Calculator, User, ShieldCheck } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="mb-10 px-2 flex flex-col gap-1">
        <h1 className="text-2xl font-black" style={{ color: "var(--primary)" }}>Sakk</h1>
        <p className="text-[9px] uppercase tracking-[0.15em] font-bold" style={{ color: "var(--outline)" }}>
      ...
      <div className="mt-auto space-y-3">
        <Link
          ...
          style={{ background: "var(--primary)", boxShadow: "0 4px 14px rgba(0,106,102,0.28)", textDecoration: "none" }}
        >
          Post a Plate
        </Link>
        <div className="p-3 rounded-xl flex items-center gap-2.5" style={{ background: "rgba(0,106,102,0.06)" }}>
